...
class CaptioningRNN:
    ...
    def loss(self, features, captions):
        ...
        h,rnn_cache = forward(emb, h0, Wx, Wh, b)
        ...
        dh, grads['W_vocab'], grads['b_vocab'] = temporal_affine_backward(dx, temp_cache)
        demb, dh0, grads["Wx"], grads["Wh"], grads["b"] = backward(dh, rnn_cache)
    ...
    def sample(self, features, max_length=30):
        ...
        if self.cell_type == 'rnn':
          forward = rnn_step_forward
          

        prev_word = np.repeat(self._start, N)
        for i in range(max_length):
          emb_word, _ = word_embedding_forward(prev_word, W_embed)
          h0, _ = forward(emb_word, h0, Wx, Wh, b)
